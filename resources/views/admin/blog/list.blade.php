    ...
    <div class="col-lg-12">
        <form method="post">
            ...
            <div class="show-delete pb-2">
                <button class="btn btn-danger btn-sm" formaction="{{url('/admin/bg/delete')}}"><i
                        class="fa fa-trash mr-1"></i>Xóa mục đã chọn</button>
            </div>
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <td>
                            <form method="post">
                                <button type="submit" class="btn btn-danger btn-sm"
                                    ...
                                    onclick="return confirm('Xoá bài viết ? ');"><i class="fa fa-times"></i></button>
                                @method('delete')
                                @csrf
                            </form>
                        </td>
