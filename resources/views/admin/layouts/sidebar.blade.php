        ...
        <div class="nav">
            ...
            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav">
                    <a class="nav-link" href="/admin/slide/create">Thêm mới</a>
            ...
            <div class="collapse" id="dept" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav">
                    <a class="nav-link" href="/admin/dept/create">Thêm mới</a>
                    <a class="nav-link" href="/admin/dept">Danh sách</a>
                </nav>
            </div>
            <!-- Nhan vien -->
            ...
            <div class="collapse" id="mem" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav">
                    <a class="nav-link" href="/admin/staff/create">Thêm mới</a>
