          ...
          <div class="row">
            <div class="col-lg-3">
              <div class="what-left">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum, rerum numquam quas sint quisquam nihil vero omnis facilis repellat nobis,.</p>
              </div>
            </div>
            {{-- end col 4 --}}
            <div class="col-lg-9">
                      ...
                      <div class="form-group">
                        ...
                        <div class="list-option">
                          <div class="row">
                            <div class="col-lg-6">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="optradio"><span>Branding &
                                  Consulting</span>
                              </label>
                            </div>
                            <div class="col-lg-6">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="optradio"><span>Graphic Design &
                                  Illustration</span>
                              </label>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-6">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="optradio"><span>Digital
                                  Strategy</span>
                              </label>
                            </div>
                            <div class="col-lg-6">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="optradio"><span>Multimedia
                                  Content</span>
                              </label>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="col-lg-6">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="optradio"><span>Creative
                                  Campaigns</span>
                              </label>
                            </div>
                            <div class="col-lg-6">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="optradio"><span>Photo o Video</span>
                              </label>
                            </div>
                          </div>
                          <!-- End row -->
                          <div class="row">
                            <div class="col-lg-6">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="optradio"><span>UI/UX Design</span>
                              </label>
                            </div>
                            <div class="col-lg-6">
                              <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="optradio"><span>Other (challenge
                                  us)</span>
                              </label>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-8">
                            <div class="slidecontainer">
                              <input type="range" min="1" max="30" value="15" class="slider" id="range" name="range"
                             >
                    ...
                    <div class="col-6">
                      <div class="about-left text-center text-white p1">
                        <div class="col-lg-8 offset-lg-2">
                          ...
                          <button class="btn btn-outline-light mt-5 btn-send" name="btn_fb"><i class="fa fa-paper-plane pr-1"
                              aria-hidden="true"></i>Send Us</button>
                        </div>
                      </div>
                    </div>
